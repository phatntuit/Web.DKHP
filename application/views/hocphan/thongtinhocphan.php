...
<section id="content">
	<div class="row" id="result">
					...
					<table id="tablehocphan" class="table table-bordred table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php if($hp->Hinhthuc=="LT") echo "Lý Thuyết";else echo "Thực Hành";?></td>
		...
		<div class="modal fade" id="deletehocphan" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
